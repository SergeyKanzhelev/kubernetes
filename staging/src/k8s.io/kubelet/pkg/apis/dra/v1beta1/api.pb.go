...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	0x91, 0x68, 0xa2, 0x0f, 0xb7, 0xc7, 0x68, 0x0f, 0x13, 0x17, 0xa7, 0x4b, 0x90, 0x63, 0x40, 0x4e,
	...
	0x0a, 0xd0, 0xad, 0x52, 0x47, 0x35, 0x03, 0x53, 0x05, 0xcc, 0x32, 0x0d, 0xc2, 0x0a, 0xe1, 0xd6,
	0x85, 0x73, 0xf1, 0x85, 0x27, 0x96, 0x24, 0x67, 0x20, 0xac, 0x91, 0x47, 0xe8, 0x46, 0x95, 0x81,
	0x19, 0xaf, 0x80, 0x5b, 0x01, 0xcc, 0x58, 0x03, 0x46, 0x27, 0xc7, 0x13, 0x0f, 0xe5, 0x18, 0x6f,
	0x3c, 0x94, 0x63, 0x68, 0x78, 0x24, 0xc7, 0x78, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72, 0x8c,
	0x0f, 0x1e, 0xc9, 0x31, 0x4e, 0x78, 0x2c, 0xc7, 0x10, 0xa5, 0x8c, 0x3f, 0x32, 0xc0, 0x11, 0x9c,
	0xc4, 0x06, 0x8e, 0x08, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x4a, 0x64, 0x5a, 0xf5, 0xfd,
	0x01, 0x00, 0x00,
}
...
type DRAPluginClient interface {
	...
	WatchResources(ctx context.Context, in *v1alpha4.WatchResourcesRequest, opts ...grpc.CallOption) (DRAPlugin_WatchResourcesClient, error)
}
...
func (c *dRAPluginClient) WatchResources(ctx context.Context, in *v1alpha4.WatchResourcesRequest, opts ...grpc.CallOption) (DRAPlugin_WatchResourcesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DRAPlugin_serviceDesc.Streams[0], "/v1beta1.DRAPlugin/WatchResources", opts...)
	if err != nil {
		return nil, err
	}
	x := &dRAPluginWatchResourcesClient{stream}
...
type DRAPlugin_WatchResourcesClient interface {
	Recv() (*v1alpha4.WatchResourcesResponse, error)
	grpc.ClientStream
}

type dRAPluginWatchResourcesClient struct {
	grpc.ClientStream
}

func (x *dRAPluginWatchResourcesClient) Recv() (*v1alpha4.WatchResourcesResponse, error) {
	m := new(v1alpha4.WatchResourcesResponse)
...
type DRAPluginServer interface {
	...
	// WatchResources returns a stream of DeviceHealth
	WatchResources(*v1alpha4.WatchResourcesRequest, DRAPlugin_WatchResourcesServer) error
}
...
func (*UnimplementedDRAPluginServer) WatchResources(req *v1alpha4.WatchResourcesRequest, srv DRAPlugin_WatchResourcesServer) error {
...
func _DRAPlugin_WatchResources_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(v1alpha4.WatchResourcesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DRAPluginServer).WatchResources(m, &dRAPluginWatchResourcesServer{stream})
}

type DRAPlugin_WatchResourcesServer interface {
	Send(*v1alpha4.WatchResourcesResponse) error
	grpc.ServerStream
}

type dRAPluginWatchResourcesServer struct {
	grpc.ServerStream
}

func (x *dRAPluginWatchResourcesServer) Send(m *v1alpha4.WatchResourcesResponse) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _DRAPlugin_WatchResources_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "api.proto",
