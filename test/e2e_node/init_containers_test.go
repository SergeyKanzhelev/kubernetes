...
var _ = SIGDescribe("[NodeConformance] InitContainers ", func() {
	...
	ginkgo.It("should not launch before PostStart of regular container", func() {
		init1 := "init-1"
		regular1 := "regular-1"
	...
	ginkgo.It("container with restartAlways will be restarted", func() {
		...
		err := e2epod.WaitForPodContainerRestartCount(context.TODO(), f.ClientSet, podSpec.Namespace, podSpec.Name, 0, 3, 2*time.Minute)
		framework.ExpectNoError(err)
	...
	ginkgo.It("should not launch second container before PostStart of the first regular container completed", func() {
